...
<body id="page-top">
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/logo.gif" alt="..." />
			<!-- Masthead Heading-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Tech Course
				Finder Website</p>
		</div>
	</header>
	<!-- Portfolio Section-->
			...
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<p class="lead mb-0">
						...
						<a href="CourseVenia.com">Explore our service</a> .
					</p>
				</div>
			</div>
		</div>
